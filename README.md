...
> [!IMPORTANT]
> _The legacy directory "e26", which was used until now for the source folders, has been renamed "enlighten".
...
>
> _Use version [V17.4](https://github.com/batden/extinguish/releases/tag/V17.4) of the EXTINGUISH script before reinstalling the environment._
>
> _Sorry for the inconvenience._

**This is a Bash script for building, installing, or updating Enlightenment on Ubuntu 22.04 LTS.**
