...
# If you find our scripts useful, please star our repositories. Thank you!
...
e_bkp() {
  ...
  # cp -aR /home/riley/Documents/ebackups/e_1790229725/.elementary/ /home/riley/
  # cp -aR /home/riley/Documents/ebackups/e_1790229725/.e/ /home/riley/
  # cp -aR /home/riley/Documents/ebackups/eterm_1790229725/terminology/config/ /home/riley/.config/terminology/
  # cp -aR /home/riley/Documents/ebackups/eterm_1790229725/terminology/themes/ /home/riley/.config/terminology/
...
chk_ddctl() {
  if [ -d "$esrc/ddcutil-3.0.0" ] || [ -d "$esrc/ddcutil-3.0.1" ]; then
    printf "\n$bold%s $off%s\n" "Updating ddcutil..."

    if [ -d "$esrc/ddcutil-3.0.0" ]; then
      olddir="$esrc/ddcutil-3.0.0"
    elif [ -d "$esrc/ddcutil-3.0.1" ]; then
      olddir="$esrc/ddcutil-3.0.1"
    fi
